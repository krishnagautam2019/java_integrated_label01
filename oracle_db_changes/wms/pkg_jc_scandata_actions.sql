CREATE OR REPLACE package jc_scandata_actions as
    ...
    procedure manifest_trlr_on_success      (
                          v_tc_shipment_id  in      varchar2
                        , v_report_type     in      varchar2
                        , v_report_url      in      varchar2 );
...
CREATE OR REPLACE package body jc_scandata_actions as
    ...
    procedure manifest_trlr_on_success      (
        ...
        v_scandata_docs_id      c_scandata_docs.c_scandata_docs_id%type := 0;
        v_ship_via              shipment.assigned_ship_via%type;
    begin
        select sh.assigned_ship_via
          into v_ship_via
          from shipment sh
